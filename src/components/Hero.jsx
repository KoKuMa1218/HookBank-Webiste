...
import {discount, healthtech, robot} from '../assets'
  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 flex justify-start items-start flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
           <span className="text-gradient">E</span>xpert  <br className="sm:block hidden"/> {" "}
           <span className="text-gradient">T</span>echnology <br className="sm:block hidden"/> {" "}
        ...
        <h1  className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">
          <span className="text-gradient">D</span>evelopment <br className="sm:block hidden"/> {" "}
        </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:mr-0  my-10 relative`}>
        <img src={healthtech} className="w-[100%] h-[100%] relative z-[5]" alt="" srcset="" />
